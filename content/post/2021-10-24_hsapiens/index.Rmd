...
genes_df2 <- genes %>% 
  ...
  mutate(
    ...
    pfam_id = AnnotationDbi::mapIds(org.Hs.eg.db,
                                      keys = genes$gene_id,
                                      keytype = "ENTREZID",
                                      column = "PFAM",
                                      multiVals = "first"
...
mypalette<-brewer.pal(25,"Greens")
library(PFAM.db)
