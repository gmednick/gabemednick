...
# Intro to the Tidyverse
 There are five related datasets but we will only look at `key_crop_yields` dataset in this exploration. The data contains crop yield (tonnes per hectare) by country and year. Let's get started by loading the packages that we will need for this analysis.
