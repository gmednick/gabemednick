...
The animated map below (not included in the covid app) shows the change in cases over the last 12 months.
```{r}
...
This map includes county level case details (not included in the covid app because of memory appropriation).
```{r}
