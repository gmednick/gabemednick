...
```
#### The animated map below shows the changes in cases over the last 12 months. 
```{r}
...
#### This map includes county level case details but was not included in the covid app because of memory appropriation.
```{r}
