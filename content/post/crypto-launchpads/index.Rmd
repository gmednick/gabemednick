...
We can render the historical price data for TrustSwap as an interactive chart that allows the user to engage with the data by scrolling over the plot. 
...
Word clouds are a great way to visualize the most common words. Word size is used to represent the frequency a word's usage.
