...
tags: []
subtitle: ''
summary: Visualizing market dynamics, webscraping and accessing twitter data for natural language processing 
authors: []
lastmod: ''
featured: no
image:
...
No need for a :crystal_ball: to read TrustSwap's future. We can use webscraping to extract their roadmap and find out what they've got up their sleeves. 
...
The code magic behind this post is available on [GitHub](https://github.com/gmednick/gabemednick/blob/master/content/post/crypto-launchpads/index.Rmd)
