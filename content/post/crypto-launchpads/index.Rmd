...
```{r}
# Taccess the coin ids of interest from Coingecko's complete coin list. 
...
#scales::show_col(c("#ffffff", "#f2fbd2", "#c9ecb4", "#93d3ab", "#448CF6"))
...
# Webscraping Trustswap's roadmap and tokenomics
...
# Searching the twitter API for tweets that reference @trustswap
