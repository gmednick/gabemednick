...
After exploring basic market comparisons, I will take a deeper dive into TrustSwap. We will look at the company's fundamental objectives and webscrape regarding its services, roadmap and tokenomics from various sources such as TrustSwap's [website](https://trustswap.org),  [etherscan](https://etherscan.io/token/0xcc4304a31d09258b0029ea7fe63d032f52e44efe). Then we will wrap up with some natural language processing using Twitter data related to the [@TrustSwap](https://twitter.com/TrustSwap) Twitter handle. Let's get started!
...
Let's go a little deeper to see what TrustSwap has up its sleeves. 
```{r}
...
Another convenient way to visualize the most common words is the word cloud which uses word size to represent frequency.
