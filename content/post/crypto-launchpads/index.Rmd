...
A one-line description of TrustSwap is available on their Medium page. It turns out they are more than just a launchpad.
...
TrustSwap's website does not have a simple description but rather, provides a portal and a description of each service they offer. 
...
This impressive list of services doesn't even include their recent acquisition of the The Crypto App.

## Roadmap and tokenomics

To read TrustSwap's future, we can use webscraping to extract their roadmap and find out what's up their sleeve. 
