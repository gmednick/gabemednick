...
After training the models, we will convert the script into a command line tool that takes model choice, bill length and depth as variable inputs and returns the predicted penguin species. 
...
If you want to make your own penguin predictions, the script is available on [GitHub](https://github.com/gmednick/penguin-prediction-tool/blob/main/penguin_sh_tool.R) <br>
