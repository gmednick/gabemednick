...
My current professional focus on data science and bioinformatics started out as an effort to expand my scientific toolbox but quickly turned into my primary interest. I enjoy the challenge of drawing insight from all types of data. Each step of the process, from data cleaning and exploratory analysis to creating models, deriving predictions and communicating results is a blend of craft and science. Finding that dynamic balance, deriving insight and creating value is what drives my passion as a data scientist.
