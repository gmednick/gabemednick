...
A few years ago, I thought it would be fun to pick up a little bioinformatics and data science using python and R. What started out as an effort to expand my scientific toolbox turned into a passion for programming and machine learning. In the process, it has transformed my skill set and expanded my professional repertoire. I enjoy the challenge of drawing insight from all types of data. Each step of the process, from data cleaning and exploration to creating models, deriving predictions and communicating results, is a blend of art and science. Finding that blend, deriving insight and creating value is what drives my passion as a data scientist.
